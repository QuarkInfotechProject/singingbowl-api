    ...
    public function toArray($notifiable)
    {
        ...
        return [
            ...
            'message' => $this->product->product_name
                ? "{$this->product->product_name} is currently low in stock. Remaining quantity: {$this->product->quantity}"
                : "The variant '{$variantDetails}' of product '{$this->product->product->product_name}' is currently low in stock. Remaining quantity: {$this->product->quantity}"
        ];
    }
}
