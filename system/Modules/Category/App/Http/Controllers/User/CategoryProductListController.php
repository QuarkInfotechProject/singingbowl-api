...
use Modules\Category\Service\User\CategoryProductListService;
use Modules\Shared\App\Http\Controllers\AdminBaseController;

class CategoryProductListController extends AdminBaseController
{
    /**
     * @OA\Get(
     ...
     * )
     */
    function __construct(private CategoryProductListService $categoryProductListService)
    {
    }

    function __invoke()
    {
        $categories = $this->categoryProductListService->index();
