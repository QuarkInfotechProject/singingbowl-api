...
class FlashSaleCreateRequest extends FormRequest
{
    ...
    {
        return [
            'campaign_name' => 'required|string|min:2|max:255|unique:flash_sales,campaign_name',
            'product_id' => 'required|array|min:1',
            'product_id.*' => 'uuid|exists:products,uuid',
            'start_date' => 'required|date',
            'end_date' => 'required|date|after:start_date',
            'theme_color' => 'required|integer|exists:colors,id',
            'text_color' => 'required|integer|exists:colors,id',
