        ...
        <tr>
            <td align="center">
                <div class="email-container"
                    ...
                    <h1 style="color: #333;font-size: 24px;margin-bottom: 15px;font-weight: 600;"><?php echo e($sendRegisterEmailDTO->title ?? 'You\'re Almost There!'); ?></h1>
                    ...
                    <div class="code-container" style="background-color: #f9f9f9;padding: 20px;border-radius: 10px;margin-bottom: 20px;">
                        <div style="color: #666;margin-bottom: 25px;line-height: 1.6;">
                            <?php echo e($sendRegisterEmailDTO->description); ?>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center">
                                    <span style="display: inline-block;background: #fff;border: 2px solid #0066cc;padding: 12px 20px;border-radius: 8px;font-weight: bold;font-size: 18px;letter-spacing: 2px;color: #0066cc;"><?php echo e($sendRegisterEmailDTO->code); ?></span>
                                </td>
                            </tr>
                        </table>
                    </div>
